...
import (
	...
	loggingv1beta1 "github.com/openshift/elasticsearch-operator/pkg/apis/logging/v1beta1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &loggingv1beta1.Kibana{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &loggingv1beta1.Kibana{},
	})
	if err != nil {
		return err
	}
...
// and what is in the Kibana.Spec
...
func (r *ReconcileKibana) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set Kibana instance as the owner and controller
...
func newPodForCR(cr *loggingv1beta1.Kibana) *corev1.Pod {
