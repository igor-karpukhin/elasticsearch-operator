...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ElasticsearchBootstrap) DeepCopyInto(out *ElasticsearchBootstrap) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ElasticsearchBootstrap.
func (in *ElasticsearchBootstrap) DeepCopy() *ElasticsearchBootstrap {
	if in == nil {
		return nil
	}
	out := new(ElasticsearchBootstrap)
	in.DeepCopyInto(out)
	return out
}
